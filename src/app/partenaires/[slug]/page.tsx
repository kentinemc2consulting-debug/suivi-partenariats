                                ...
                                <Card key={pub.id} className="p-6 card-elevated">
                                    <div className="flex items-start justify-between">
                                        <div className="flex-1 space-y-3">
                                            ...
                                            {/* Screenshots Gallery */}
                                            {pub.screenshotUrls && pub.screenshotUrls.length > 0 && (
                                                <div className="mt-3">
                                                    <p className="text-xs text-white/60 mb-2">Screenshots du post :</p>
                                                    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-2">
                                                        {pub.screenshotUrls.map((url, idx) => (
                                                            <a
                                                                key={idx}
                                                                href={url}
                                                                target="_blank"
                                                                rel="noopener noreferrer"
                                                                className="block rounded-lg overflow-hidden border border-white/10 hover:border-primary-500/50 transition-all hover:scale-105"
                                                            >
                                                                <img
                                                                    src={url}
